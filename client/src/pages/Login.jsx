      ...
      <div className="w-full flex flex-col items-center justify-center p-4">
        <div className="w-full max-w-md">
          ...
          <div className="bg-white w-full rounded-lg p-6">
            {step === 'email' ? (
              <>
                <h2 className="text-center text-xl font-semibold text-gray-800 mb-6">Log in to continue</h2>
              ...
              <>
                <h2 className="text-center text-xl font-semibold text-gray-800 mb-6">Enter your password</h2>
                ...
                <div className="bg-gray-100 px-3 py-2 rounded-md mb-4 flex items-center">
          ...
          <div className="mt-6 flex justify-center space-x-4 text-sm text-gray-600">
            <Link to="#" className="hover:underline">Can't log in?</Link>
            <span>•</span>
